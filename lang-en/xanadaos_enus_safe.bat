...
echo Made by Shawn Rober from Program Buddies.
...
echo 2) Restart
echo 3) Write
echo 4) View File (only if you have written a file in Write)
echo 5) Back
echo 6) More
set /p choice6=C:\
...
if %choice6% == 3 goto write1
if %choice6% == 4 goto viewwrite1
if %choice6% == 5 goto desktop1
if %choice6% == 6 goto desktop3
goto desktop2
...
echo And no, Wales isn't a part of England you piece of .... not gonna say it you.. YOU!
echo Try Again = 1
...
echo The thunder is about %thunderdistance% meters away from you.
pause
goto desktop1
